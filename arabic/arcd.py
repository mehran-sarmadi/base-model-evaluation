...
def arcd_main(model_name_or_path, logger, output_dir, tokenizer_name_or_path=None):
    logger.info("Loading dataset...")
    raw_datasets = load_dataset("hsseinmz/arcd")
    train_test_split = raw_datasets['validation'].train_test_split(test_size = 0.5, seed=42)
    raw_datasets['validation'] = train_test_split['train']
